   ...
   public function run(): void
    {
        ...
        DB::table('exercises')->insert([
            ...
            [
                'id' => 1,
                'title' => 'Introducción',
                'description' => 'SQL es un lenguaje diseñado para comunicarse con bases de datos. Dependiendo de las sentencias que utilicemos, podremos añadir, borrar o mostrar datos de la base de datos. Nosotros nos centraremos en las consultas SELECT, que sirven para mostrar los datos de tablas ya existentes.<br>Las tablas son las unidades en las que se divide una base de datos. Para sacar información de una base de datos lo idóneo es conocer de antemano su estructura: qué tablas tiene y cómo se relacionan entre sí. Durante este curso podrás hacerlo con el botón de Mostrar tablas.<br>Para conocer los datos que contiene una tabla escribiremos lo siguiente: <span class="font-monospace">SELECT * FROM nombredetabla;</span><br>El asterisco significa todo, por lo que sacaremos la información completa de la tabla. Para completar el ejercicio, intenta mostrar toda la información de la tabla <span class="font-monospace">games</span>',
